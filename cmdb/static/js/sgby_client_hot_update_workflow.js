...
function display_overview_file_list() {
    ...
    var table_structrue = `
            <div class="alert alert-danger" id="show_update_version_msg">
...
function get_client_type_list() {
    ...
    $(".update_content").each(function (i, e) {
        var update_client_type = $($(e).children().get(0)).find('select');
        var update_version = $($(e).children().get(3)).find('input');
        var client_type_dict = {};
        client_type_dict[update_version.val().trim()] = update_client_type.val();
