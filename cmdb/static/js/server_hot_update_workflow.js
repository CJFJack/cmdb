...
function initModalSelect2(){
    ...
    $select2HotServerType.on("select2:select", function (e) { show_file_or_cmd("select2:select", e, $( this )); });
    ...
    $select2UpdateVersion.on("select2:select", function (e) { display_server_list("select2:select", e, $( this )); });
};
...
$(document).ready(function() {
    ...
    $("#example-basic").steps({
        ...
        onFinished: function(event, currentIndex) {
            ...
            // 文件列表数据
            if ( hot_server_type != '2' ) { get_selected_file_list(); }
            var inputs = {
                'workflow': workflow,
                'title': title,
                'reason': reason,
